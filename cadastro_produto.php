...
<div class="form-linha" style="align-items: flex-end;">
    <div class="form-group" style="flex: 1;">
        ...
        <input type="text" name="codigo" id="codigo_produto" placeholder="Clique em gerar" required readonly style="background: #f0f0f0;">
    </div>
    <div class="form-group" style="width: auto;">
        <button type="button" onclick="gerarCodigoFrontend(2, 'codigo_produto')" class="btn-primary" style="margin: 0; padding: 12px 20px; background: #e06c00;">Gerar Código</button>
    </div>
</div>
        ...
        alert("Erro ao gerar código.");
                ...
                <div class="form-linha">
                 ...
                 <div class="form-group">
                        ...
                        <input type="text" name="codigo_rfid"  required>
                    </div>
